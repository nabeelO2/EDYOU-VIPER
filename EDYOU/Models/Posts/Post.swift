...
//        case isReacted = "is_liked"
        ...
        case school = "school_info"

    }
    
//    required init(from decoder: Decoder) throws {
//        let values = try decoder.container(keyedBy: CodingKeys.self)
//        school = try values.decodeIfPresent(UserSchool.self, forKey: .school) ?? UserSchool(school_id: "", college: "", state_code: "", state: "", email_suffix: "")
//
//    }
    
    func getmyReaction()->PostLike?{
        
        let reaction = self.reactions?.first(where: { obj in
            obj.userId?.lowercased() == User.me.userID?.lowercased()
        })
