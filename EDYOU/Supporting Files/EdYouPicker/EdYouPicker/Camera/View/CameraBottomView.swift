...
class CameraBottomView: UIView {
    ...
    lazy var backButton: UIButton = {
        ...
        button.hx_size = button.currentImage?.size ?? .zero
    ...
    lazy var takeBgView: UIVisualEffectView = {
        ...
        view.hx_size = CGSize(width: 80, height: 80)
        view.layer.cornerRadius = view.hx_width * 0.5
    ...
    lazy var takeView: UIView = {
        let view = UIView()
        view.hx_size = CGSize(width: 60, height: 60)
...
//        maskAnimation.delegate = self
    ...
    func setTakeMaskLayerPath() {
        let path = UIBezierPath(
            arcCenter: CGPoint(
                x: takeBgView.hx_width * 0.5,
                y: takeBgView.hx_height * 0.5
            ),
            radius: takeBgView.hx_width * 0.5 - 2.5,
    ...
    override func layoutSubviews() {
        ...
        maskLayer.frame = CGRect(x: 0, y: -20, width: hx_width, height: hx_height + 20)
        backButton.hx_x = hx_width * 0.5 - 120
        backButton.centerY = hx_height * 0.5
        takeBgView.center = CGPoint(x: hx_width * 0.5, y: hx_height * 0.5)
        takeView.center = CGPoint(x: hx_width * 0.5, y: hx_height * 0.5)
        tipLb.frame = CGRect(
            x: UIDevice.leftMargin + 15,
            y: takeBgView.hx_y - 40,
        ...
        if takePhotoMode == .click {
            ...
            case .video:
                ...
                maskLayer.frame = CGRect(x: 0, y: -30, width: hx_width, height: hx_height + 30)
            case .all:
                maskLayer.frame = CGRect(x: 0, y: -40, width: hx_width, height: hx_height + 40)
                photoButton.frame = .init(x: typeView.hx_width * 0.5 - 110, y: 0, width: 100, height: typeView.hx_height)
                videoButton.frame = .init(x: typeView.hx_width * 0.5 + 10, y: 0, width: 100, height: typeView.hx_height)
                videoTimeLb.frame = typeView.frame
            }
        }
    }
