...
extension PhotoTools {
    ...
    public static func getWXPickerConfig(
        ...
        config.photoList.titleView.arrow.backgroundColor = "#B2B2B2".hx_Color
        config.photoList.titleView.arrow.arrowColor = "#2E2F30".hx_Color
        ...
        config.photoList.cameraCell.backgroundColor = "#404040".hx_Color
        config.photoList.cameraCell.cameraImageName = "hx_picker_photoList_photograph_white"
        
        config.photoList.limitCell.backgroundColor = "#404040".hx_Color
        config.photoList.limitCell.lineColor = .white
        config.photoList.limitCell.titleColor = .white
        config.photoList.assetNumber.textColor = "#ffffff".hx_Color
        ...
        config.previewView.livePhotoMark.textColor = "#ffffff".hx_Color
        config.previewView.livePhotoMark.imageColor = "#ffffff".hx_Color
