...
//  EdYouPickerExample
//
//  Created by imac3 on 2020/12/26.
            ...
            if let cell = previewViewController?.getCell(
               ...
               let contentView = cell.scrollContentView {
                ...
                if  (cell.scrollView.isZooming ||
                        ...
                        (toRect.minX != 0 && contentView.hx_width > cell.scrollView.hx_width))
                        && !canInteration {
            ...
            if let cell = previewVC?.getCell(
               ...
               let contentView = cell.scrollContentView {
                ...
                if  (cell.scrollView.isZooming ||
                        ...
                        cell.scrollView.contentOffset.y > 0 ||
                        !cell.allowInteration ||
                        (toRect.minX != 0 && contentView.hx_width > cell.scrollView.hx_width)) && !canInteration {
                    return (false, isTracking)
                }else {
                    isTracking = cell.scrollView.isTracking
                }
            ...
            if !previewViewController.statusBarShouldBeHidden {
                ...
                if type == .pop {
                    ...
                    if hasPreviewMask {
                        ...
                        let maskWidth = previewViewController.bottomView.hx_width
                        let maskHeight = previewViewController.bottomView.hx_height - maskY
                ...
                if !previewViewController.statusBarShouldBeHidden {
                    ...
                    if self.type == .pop {
                        ...
                        if previewViewController.bottomView.mask != nil {
                            let maskHeight = previewViewController.bottomView.hx_height
                            previewViewController.bottomView.mask?.frame = CGRect(
                                origin: .zero,
                                size: CGSize(
                                    width: maskWidth,
            ...
            UIView.animate(
                ...
                if !previewViewController.statusBarShouldBeHidden {
                    ...
                    if self.type == .pop {
                        let maskWidth = previewViewController.bottomView.hx_width
                        if previewViewController.bottomView.mask != nil {
                            let maskHeight = previewViewController.bottomView.hx_height - 70
                            previewViewController.bottomView.mask?.frame = CGRect(
                                x: 0,
                                y: 70,
                                width: maskWidth,
        ...
        if previewShowSelectedView && !pickerShowParompt {
            let maskView = UIView(
                frame: CGRect(
                    x: 0,
                    y: 0,
                    width: previewViewController.view.hx_width,
