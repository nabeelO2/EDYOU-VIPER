...
public struct PhotoListConfiguration {
    ...
    /// 暗黑风格下背景颜色
    public var backgroundDarkColor: UIColor = "#2E2F30".hx_Color
    ...
    /// Save the photo to the system gallery after taking it.
    public var saveSystemAlbum: Bool = false
    
    /// Save the photo with the name of the custom album. If the name is empty, use the BundleName.
...
extension PhotoListConfiguration {
    ...
    public struct CameraCell {
        ...
        /// 背景颜色
        public var backgroundColor: UIColor? = "#f1f1f1".hx_Color
        
        /// 暗黑风格下背景颜色
        public var backgroundDarkColor: UIColor? = "#404040".hx_Color
...
extension PhotoListConfiguration {
    ...
    public struct LimitCell {
        ...
        /// 加号颜色
        public var lineColor: UIColor = "#999999".hx_Color
        
        /// 加号暗黑模式下的颜色
        public var lineDarkColor: UIColor = "#ffffff".hx_Color
        ...
        /// 标题颜色
        public var titleColor: UIColor = "#999999".hx_Color
...
extension PhotoListConfiguration {
    ...
    public struct AddTextCell {
        ...
        /// Title Color
        public var titleColor: UIColor = "#EEEEEE".hx_Color
...
extension PhotoListConfiguration {
    ...
    public struct AssetNumber {
        public var textColor: UIColor = "#333333".hx_Color
        public var textDarkColor: UIColor = "#ffffff".hx_Color
