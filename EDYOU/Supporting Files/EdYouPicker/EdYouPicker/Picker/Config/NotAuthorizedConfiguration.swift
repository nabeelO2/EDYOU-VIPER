...
public struct NotAuthorizedConfiguration {
    ...
    /// 暗黑风格下的背景颜色
    public var darkBackgroundColor: UIColor = "#2E2F30".hx_Color
    ...
    /// 子标题颜色
    public var subTitleColor: UIColor = "#444444".hx_Color
    
    /// 暗黑风格下的子标题颜色
    public var darkSubTitleColor: UIColor = .white
    
    /// 跳转按钮背景颜色
    public var jumpButtonBackgroundColor: UIColor = "#333333".hx_Color
    
    /// 暗黑风格下跳转按钮背景颜色
    public var jumpButtonDarkBackgroundColor: UIColor = .white
    
    /// 跳转按钮文字颜色
    public var jumpButtonTitleColor: UIColor = "#ffffff".hx_Color
    
    /// 暗黑风格下跳转按钮文字颜色
    public var jumpButtonTitleDarkColor: UIColor = "#333333".hx_Color
