...
extension PreviewViewConfiguration {
    public struct LivePhotoMark {
        ...
        var imageColor: UIColor = "#666666".hx_Color
        var textColor: UIColor = "#666666".hx_Color
        
        var imageDarkColor: UIColor = "#ffffff".hx_Color
        var textDarkColor: UIColor = "#ffffff".hx_Color
