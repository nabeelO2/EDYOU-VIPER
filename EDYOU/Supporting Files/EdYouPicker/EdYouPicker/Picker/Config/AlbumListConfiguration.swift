...
public struct AlbumListConfiguration {
    ...
    /// 可访问权限下的提示语颜色
    public var limitedStatusPromptColor: UIColor = "#999999".hx_Color
    
    /// 暗黑风格可访问权限下的提示语颜色
    public var limitedStatusPromptDarkColor: UIColor = "#999999".hx_Color
    ...
    /// 暗黑风格下cell背景颜色
    public var cellbackgroundDarkColor: UIColor = "#2E2F30".hx_Color
    ...
    /// 照片数量颜色
    public var photoCountColor: UIColor = "#999999".hx_Color
    
    /// 暗黑风格下相册名称颜色
    public var photoCountDarkColor: UIColor = "#dadada".hx_Color
    ...
    /// 分隔线颜色
    public var separatorLineColor: UIColor = "#eeeeee".hx_Color
    
    /// 暗黑风格下分隔线颜色
    public var separatorLineDarkColor: UIColor = "#434344".hx_Color.withAlphaComponent(0.6)
    
    /// 选中勾勾的颜色
    public var tickColor: UIColor = .systemTintColor
    
    /// 暗黑风格选中勾勾的颜色
    public var tickDarkColor: UIColor = "#ffffff".hx_Color
