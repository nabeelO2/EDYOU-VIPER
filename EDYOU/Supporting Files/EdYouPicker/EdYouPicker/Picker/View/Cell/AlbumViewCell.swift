...
open class AlbumViewCell: UITableViewCell {
    ...
    open func layoutView() {
        ...
        tickView.hx_x = hx_width - 12 - tickView.hx_width - UIDevice.rightMargin
        tickView.centerY = hx_height * 0.5
        ...
        if let showPhotoCount = config?.showPhotoCount, showPhotoCount {
            albumNameLb.centerY = hx_height / 2 - albumNameLb.hx_height / 2
            ...
            albumNameLb.centerY = hx_height / 2
        }
