...
open class PhotoPickerViewCell: PhotoPickerBaseViewCell {
    ...
    open override func layoutView() {
        super.layoutView()
        iCloudMarkView.hx_x = hx_width - iCloudMarkView.hx_width - 5
        iCloudMarkView.hx_y = 5
        
        assetTypeMaskView.frame = CGRect(x: 0, y: photoView.hx_height - 25, width: hx_width, height: 25)
        let assetTypeMakeFrame = CGRect(
            x: 0,
            y: -5,
            width: assetTypeMaskView.hx_width,
            height: assetTypeMaskView.hx_height + 5
        )
        ...
        assetTypeIcon.hx_size = assetTypeIcon.image?.size ?? .zero
        assetTypeIcon.hx_x = 5
        assetTypeIcon.hx_y = hx_height - assetTypeIcon.hx_height - 5
        assetTypeLb.centerY = assetTypeIcon.centerY
        assetEditMarkIcon.hx_size = assetEditMarkIcon.image?.size ?? .zero
        assetEditMarkIcon.hx_x = 5
        assetEditMarkIcon.hx_y = hx_height - assetEditMarkIcon.hx_height - 5
    }
