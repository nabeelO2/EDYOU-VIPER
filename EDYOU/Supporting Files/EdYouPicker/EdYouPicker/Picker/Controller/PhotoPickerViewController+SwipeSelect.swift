...
//  EdYouPicker
//
//  Created by imac3 on 2020/12/31.
//
           ...
           let lastIndexPath = lastIndexPath {
            ...
            if let beganIndex = swipeSelectBeganIndexPath?.item,
               ...
               let point = swipeSelectLastLocalPoint {
                let largeHeight = collectionView.contentSize.height > collectionView.hx_height
                var exceedBottom: Bool
                let offsety = collectionView.contentOffset.y
                let maxOffsetY =
                    collectionView.contentSize.height -
                    collectionView.hx_height +
                ...
                let inScope = point.x >= 0 && point.x <= collectionView.hx_width
    ...
    private func startAutoScroll() {
        if let localPoint = swipeSelectLastLocalPoint {
            ...
            let bottomRect = CGRect(
                x: 0,
                y: collectionView.hx_height - collectionView.contentInset.bottom - config.autoSwipeBottomAreaHeight,
                width: view.hx_width,
