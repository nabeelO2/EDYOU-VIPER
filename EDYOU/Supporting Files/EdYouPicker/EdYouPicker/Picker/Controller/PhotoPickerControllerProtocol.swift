...
public protocol PhotoPickerControllerDelegate: AnyObject {
    ...
    func pickerController(
        _ pickerController: PhotoPickerController,
        didFinishMultipleSelection result: [Any]
    )
...
//    #if HXPICKER_ENABLE_EDITOR
    ...
    func pickerController(
        _ pickerController: PhotoPickerController,
        videoEditorShouldClickMusicTool videoEditorViewController: VideoEditorView
    ) -> Bool
    ...
    func pickerController(
        _ pickerController: PhotoPickerController,
        videoEditor videoEditorViewController: VideoEditorView,
...
//    #if HXPICKER_ENABLE_EDITOR
    ...
    func pickerController(
        _ pickerController: PhotoPickerController,
        loadTitleChartlet editorViewController: UIView,
        response: @escaping EditorTitleChartletResponse
    ) {
        #if canImport(Kingfisher)
        let titles = PhotoTools.defaultTitleChartlet()
    ...
    func pickerController(
        _ pickerController: PhotoPickerController,
        loadChartletList editorViewController: UIView,
        titleChartlet: EditorChartlet,
        titleIndex: Int,
        response: @escaping EditorChartletListResponse
    ) {
    ...
    func pickerController(
        ...
        videoEditorShouldClickMusicTool
            videoEditorViewController: VideoEditorView
    ) -> Bool { true }
