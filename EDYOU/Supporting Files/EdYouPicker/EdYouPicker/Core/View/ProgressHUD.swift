...
final class ProgressHUD: UIView {
    ...
    private func updateFrame() {
        if text != nil {
            ...
            if textWidth > hx_width - 100 {
                textWidth = hx_width - 100
            }
            let height = text!.height(ofFont: textLb.font, maxWidth: textWidth)
            textLb.hx_size = CGSize(width: textWidth, height: height)
        }
        var textMaxWidth = textLb.hx_width + 60
        if textMaxWidth < 100 {
            textMaxWidth = 100
        }
        ...
        if mode == .indicator {
            ...
            if text != nil {
                textLb.hx_y = indicatorView.frame.maxY + 12
            }else {
            ...
            if text != nil {
                textLb.hx_y = circleView.frame.maxY + 12
            }else {
                textLb.hx_y = circleView.frame.maxY
            }
        }else if mode == .success {
...
class ProgressIndefiniteView: UIView {
    ...
    lazy var circleLayer: CAShapeLayer = {
        ...
        let path = UIBezierPath(
            arcCenter: CGPoint(x: hx_width * 0.5, y: hx_height * 0.5),
            radius: hx_width * 0.5 - lineWidth * 0.5,
    ...
    lazy var maskLayer: CALayer = {
        ...
        topLayer.frame = CGRect(x: hx_width * 0.5, y: 0, width: hx_width * 0.5, height: hx_height)
        topLayer.colors = [
        ...
        bottomLayer.frame = CGRect(x: 0, y: 0, width: hx_width * 0.5, height: hx_height)
        bottomLayer.colors = [
            UIColor.white.withAlphaComponent(0.4).cgColor,
