...
extension String: HXPickerCompatibleValue {
    ...
    var hx_Color: UIColor { UIColor.init(hexString: self) }
...
public extension HXPickerWrapper where Base == String {
    ...
    var color: UIColor { base.hx_Color }
...
extension Array {
    func objectHX(at index: Int) -> Element? {
...
extension Array where Element: UIColor {
    ...
    var hexStringsHX: [String] {
        let s = self.map { $0.toHexStringHX() }
        return s
    }
