//
//  VideoEditor+GIPHY.swift
//  ustories
//
//  Created by imac3 on 15/07/2023.
//
...
extension VideoEditorView {
    ...
    func showGiphy(){
        ...
        parentVC?.present(giphy, animated: true, completion: nil)
    }
...
extension VideoEditorView: GiphyDelegate {
