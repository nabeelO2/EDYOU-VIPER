...
open class EditorController: UINavigationController {
    ...
    public var videoEditor: VideoEditorView? {
        viewControllers.first as? VideoEditorView
    }
    ...
    public convenience init(
        ...
        finished: VideoEditorView.FinishHandler? = nil,
        cancelled: VideoEditorView.CancelHandler? = nil
    ) {
        self.init(
