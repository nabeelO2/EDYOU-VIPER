...
//    func photoEditorViewController(
//        _ photoEditorViewController: PhotoEditorViewController,
//        didFinish result: Any
//    )
    
    
    func photoEditorViewController(
        _ photoEditorViewController: PhotoEditorViewController,
        didFinishVideo result: VideoEditResult
    )
...
public protocol VideoEditorViewControllerDelegate: AnyObject {
    ...
    /// - Parameter videoEditorViewController: 对应的 VideoEditorViewController
    func videoEditorViewController(
        didCancel videoEditorViewController: VideoEditorView
    )
    ...
    ///   - videoEditorViewController: 对应的 VideoEditorViewController
    func videoEditorViewController(
        transitionPreviewImage videoEditorViewController: VideoEditorView
    ) -> UIImage?
    ...
    func videoEditorViewController(
        transitioBegenPreviewView videoEditorViewController: VideoEditorView
    ) -> UIView?
    
    /// 界面返回时对应的视图，用于获取位置大小。与 presentPreviewFrameAt 一样
    func videoEditorViewController(
        transitioEndPreviewView videoEditorViewController: VideoEditorView
    ) -> UIView?
    
    /// 跳转界面时对应的起始位置大小
    func videoEditorViewController(
        transitioBegenPreviewFrame videoEditorViewController: VideoEditorView
    ) -> CGRect
    
    /// 界面返回时对应的位置大小
    func videoEditorViewController(
        transitioEndPreviewFrame videoEditorViewController: VideoEditorView
    ) -> CGRect
}
