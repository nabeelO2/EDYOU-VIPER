...
final class EditorStickerTextViewController: BaseViewController {
    ...
    lazy var cancelButton: UIButton = {
        ...
        button.hx_size = CGSize(width: 60, height: 30)
    ...
    lazy var finishButton: UIButton = {
        ...
        button.hx_size = CGSize(width: textWidth, height: 30)
        button.setBackgroundImage(
            UIImage.image(
                for: config.tintColor,
                havingSize: button.hx_size,
                radius: 3
            ),
            for: .normal
        )
    ...
    override func viewDidLoad() {
        ...
        if let nav = navigationController,
           nav.modalPresentationStyle == .fullScreen {
            view.backgroundColor = "#666666".hx_Color
        }else {
    ...
    override func viewDidLayoutSubviews() {
        ...
        textView.hx_x = 0
        textView.hx_y = navigationController?.navigationBar.frame.maxY ?? UIDevice.navigationBarHeight
        textView.hx_width = view.hx_width
        textView.hx_height = view.hx_height - textView.hx_y
    }
