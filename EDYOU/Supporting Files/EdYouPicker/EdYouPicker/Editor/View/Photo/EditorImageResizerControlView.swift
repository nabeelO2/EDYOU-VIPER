...
class EditorImageResizerControlView: UIView {
    ...
    override func layoutSubviews() {
        ...
        topControl.frame = CGRect(x: lineMarign, y: -lineMarign, width: hx_width - lineMarign * 2, height: lineMarign * 2)
        leftControl.frame = CGRect(
            x: -lineMarign,
            y: lineMarign,
            width: lineMarign * 2,
            height: hx_height - lineMarign * 2
        )
        rightControl.frame = CGRect(
            x: hx_width - lineMarign,
            y: lineMarign,
            width: lineMarign * 2,
            height: hx_height - lineMarign * 2
        )
        bottomControl.frame = CGRect(
            x: lineMarign,
            y: hx_height - lineMarign,
            width: hx_width - lineMarign * 2,
            height: lineMarign * 2
        )
