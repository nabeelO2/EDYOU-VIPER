...
class PhotoEditorMosaicToolView: UIView {
    ...
    override func layoutSubviews() {
        ...
        let buttonWidth = (hx_width - UIDevice.leftMargin - UIDevice.rightMargin - hx_height) * 0.5
        mosaicButton.frame = CGRect(x: UIDevice.leftMargin, y: 0, width: buttonWidth, height: hx_height)
        smearButton.frame = CGRect(x: mosaicButton.frame.maxX, y: 0, width: buttonWidth, height: hx_height)
        undoButton.frame = CGRect(x: hx_width - UIDevice.rightMargin - hx_height, y: 0, width: hx_height, height: hx_height)
    }
}
