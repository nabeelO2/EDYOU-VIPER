...
class EditorImageResizerView: UIView {
    ...
    lazy var imageView: PhotoEditorContentView = {
        ...
        imageView.itemViewMoveToCenter = { [weak self] rect -> Bool in
            ...
            if newRect.width > view.hx_width {
                newRect.origin.x = 0
                newRect.size.width = view.hx_width
            }
            if newRect.height > view.hx_height {
                newRect.origin.y = 0
                newRect.size.height = view.hx_height
            }
