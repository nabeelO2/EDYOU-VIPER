...
extension EditorImageResizerView {
    ...
    func getEditableArea() -> CGRect {
        let editWidth = containerView.hx_width - contentInsets.left - contentInsets.right
        let editHeight = containerView.hx_height - contentInsets.top - contentInsets.bottom
    ...
    func setImage(_ image: UIImage) {
        ...
        let maxControlRect = CGRect(
            ...
            y: contentInsets.top,
            width: containerView.hx_width - contentInsets.left - contentInsets.right,
            height: containerView.hx_height - contentInsets.top - contentInsets.bottom
        )
    ...
    func getInitializationRatioMaskRect() -> CGRect {
        let maxWidth = containerView.hx_width - contentInsets.left - contentInsets.right
        let maxHeight = containerView.hx_height - contentInsets.top - contentInsets.bottom
    ...
    func getImageViewFrame() -> CGRect {
        let maxWidth = containerView.hx_width
        let maxHeight = containerView.hx_height
    ...
    func updateImageViewFrame(_ imageFrame: CGRect) {
        imageView.hx_size = imageFrame.size
        baseImageSize = imageView.hx_size
        scrollView.contentSize = imageView.hx_size
        if imageView.hx_height < containerView.hx_height {
            let top = (containerView.hx_height - imageView.hx_height) * 0.5
            let left = (containerView.hx_width - imageView.hx_width) * 0.5
