...
class VideoEditorMusicView: UIView {
    ...
    override func layoutSubviews() {
        ...
        volumeBgView.frame = CGRect(
            x: hx_width - UIDevice.rightMargin - margin - volumeButtonWidth,
            y: 0,
        ...
        pageWidth = hx_width - margin * 2 - UIDevice.leftMargin - UIDevice.rightMargin + flowLayout.minimumLineSpacing
        collectionView.frame = CGRect(x: 0, y: searchBgView.frame.maxY + 15, width: hx_width, height: 90)
        ...
        flowLayout.itemSize = CGSize(width: pageWidth - flowLayout.minimumLineSpacing, height: collectionView.hx_height)
    ...
    func setBottomButtonFrame() {
        ...
        originalSoundButton.frame = CGRect(
            x: 0,
            y: backgroundButton.hx_y,
            width: originalButtonWidth,
            height: buttonHeight
        )
        originalSoundButton.centerX = hx_width * 0.5
        
        let margin: CGFloat = 35
        backgroundButton.frame = CGRect(
            x: originalSoundButton.hx_x - margin - bgButtonWidth,
        ...
        if backgroundButton.hx_x <= 0 && showLyricButton.frame.maxX >= hx_width {
            backgroundButton.hx_x = 5
            backgroundButton.hx_width = originalSoundButton.hx_x - 10
            showLyricButton.hx_x = originalSoundButton.frame.maxX + 5
            showLyricButton.hx_width = hx_width - showLyricButton.hx_x - 5
        }else if backgroundButton.hx_x <= 0 || showLyricButton.frame.maxX >= hx_width {
            let margin = (hx_width - backgroundButton.hx_width - originalSoundButton.hx_width - showLyricButton.hx_width) * 0.5
            backgroundButton.hx_x = margin
            originalSoundButton.hx_x = backgroundButton.frame.maxX
            showLyricButton.hx_x = originalSoundButton.frame.maxX
        }
    }
    deinit {
