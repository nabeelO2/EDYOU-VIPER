...
class VideoEditorMusicViewCell: UICollectionViewCell {
    ...
    lazy var musicIconView: UIImageView = {
        ...
        view.hx_size = view.image?.size ?? .zero
        return view
    }()
    ...
    func showLoading() {
        ...
        musicIconView.tintColor = "#333333".hx_Color
        songNameLb.textColor = "#333333".hx_Color
    ...
    func didPlay(audioPath: String) {
        ...
        if music.isSelected {
            ...
            DispatchQueue.main.async {
                ...
                let maxOffsetX = self.collectionView.contentSize.width - self.hx_width + (self.hx_width - 15) - startPointX
    ...
    func scrollLyric(time: TimeInterval) {
        ...
        let maxOffsetX = collectionView.contentSize.width - hx_width + (hx_width - 15)
    ...
    func setPreciseContentOffset(x: CGFloat, y: CGFloat) {
        ...
        collectionView.bounds = CGRect(origin: point, size: collectionView.hx_size)
    }
    ...
    override func layoutSubviews() {
        ...
        bgView.frame = bounds
        musicIconView.hx_x = 15
        musicIconView.hx_y = 15
        animationView.frame = CGRect(x: hx_width - 60, y: 20, width: 20, height: 15)
        songNameLb.hx_x = musicIconView.frame.maxX + 10
        songNameLb.hx_width = animationView.hx_x - 10 - songNameLb.hx_x
        songNameLb.hx_height = 20
        songNameLb.centerY = musicIconView.centerY
        shadeView.frame = CGRect(
            x: 0,
            y: musicIconView.frame.maxY + 10,
            width: hx_width,
            height: hx_height - musicIconView.frame.maxY - 20
        )
        collectionView.frame = shadeView.bounds
        maskLayer.frame = CGRect(x: 10, y: 0, width: shadeView.hx_width - 20, height: shadeView.hx_height)
        
        loadingView.center = CGPoint(x: hx_width * 0.5, y: hx_height * 0.5)
    }
...
extension VideoEditorMusicViewCell: UICollectionViewDataSource,
    ...
    func collectionView(
        ...
        cell.lyricLb.textColor = isPlaying ? "#333333".hx_Color : .white
    ...
    func collectionView(
        ...
        let cellWidth = lyric.lyric.width(
            ...
            maxHeight: shadeView.hx_height
        )
        return CGSize(width: cellWidth, height: shadeView.hx_height)
    }
}
