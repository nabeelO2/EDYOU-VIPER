...
public class EditorCropConfirmView: UIView {
    ...
    public override func layoutSubviews() {
        ...
        maskLayer.frame = CGRect(x: 0, y: showReset ? -70 : -10, width: hx_width, height: hx_height + (showReset ? 70 : 10))
        cancelButton.hx_x = UIDevice.leftMargin + 12
        ...
        cancelButton.hx_width = cancelWidth
        cancelButton.hx_height = 33
        ...
        finishButton.hx_width = finishWidth
        finishButton.hx_height = 33
        finishButton.hx_x = hx_width - finishButton.hx_width - 12 - UIDevice.rightMargin
        ...
        if showReset {
            ...
            resetButton.hx_size = CGSize(width: resetWidth, height: 33)
            resetButton.centerX = hx_width * 0.5
