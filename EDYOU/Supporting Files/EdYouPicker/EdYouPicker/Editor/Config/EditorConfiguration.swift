...
open class EditorConfiguration: BaseConfiguration {
    ...
    public struct Filter {
        ...
        /// When editing a video, whether to load the last filter effect
        /// If the filter data is inconsistent with the filter data of the last edit, it will cause loading confusion
        /// Please ensure that the filter data is consistent with the last data before loading
