...
class EdyouSegmentControl: UISegmentedControl {
    ...
    required init?(coder: NSCoder) {
        ...
        let titleTextAttributes = [NSAttributedString.Key.foregroundColor: UIColor.init(hexString: "#52B36D")]
