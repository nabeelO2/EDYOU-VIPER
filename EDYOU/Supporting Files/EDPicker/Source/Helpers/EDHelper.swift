...
internal func EDLocalized(_ str: String) -> String {
...
struct EDHelper {
    static func changeBackButtonIcon(_ controller: UIViewController) {
        if EDConfig.icons.shouldChangeDefaultBackButtonIcon {
            let backButtonIcon = EDConfig.icons.backButtonIcon
    ...
    static func changeBackButtonTitle(_ controller: UIViewController) {
        if EDConfig.icons.hideBackButtonTitle {
