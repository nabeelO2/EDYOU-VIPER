...
public protocol EDSelectionsGalleryCellDelegate: AnyObject {
    func selectionsGalleryCellDidTapRemove(cell: EDSelectionsGalleryCell)
}

public class EDSelectionsGalleryCell: UICollectionViewCell {
    
    weak var delegate: EDSelectionsGalleryCellDelegate?
    ...
    override init(frame: CGRect) {
        ...
        removeButton.setImage(EDConfig.icons.removeImage, for: .normal)
