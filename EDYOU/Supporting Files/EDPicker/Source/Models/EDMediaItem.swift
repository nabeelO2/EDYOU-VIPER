...
public enum EDMediaItem {
    case photo(p: EDMediaPhoto)
    case video(v: EDMediaVideo)
}

// MARK: - Compression

public extension EDMediaVideo {
...
public extension Array where Element == EDMediaItem {
    var singlePhoto: EDMediaPhoto? {
