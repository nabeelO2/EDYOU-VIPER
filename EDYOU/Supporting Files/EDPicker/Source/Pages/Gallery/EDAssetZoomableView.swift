...
protocol YPAssetZoomableViewDelegate: AnyObject {
    func ypAssetZoomableViewDidLayoutSubviews(_ zoomableView: EDAssetZoomableView)
    func ypAssetZoomableViewScrollViewDidZoom()
    func ypAssetZoomableViewScrollViewDidEndZooming()
}

final class EDAssetZoomableView: UIScrollView {
    ...
    public var videoView = EDVideoView()
    public var squaredZoomScale: CGFloat = 1
    public var minWidthForItem: CGFloat? = EDConfig.library.minWidthForItem
    ...
    public func applyStoredCropPosition(_ scp: EDLibrarySelection) {
    ...
    public func setVideo(_ video: PHAsset,
                         ...
                         storedCropPosition: EDLibrarySelection?,
    ...
    override init(frame: CGRect) {
        ...
        backgroundColor = EDConfig.colors.assetViewBackgroundColor
        clipsToBounds = true
...
fileprivate extension EDAssetZoomableView {
    ...
    func setAssetFrame(`for` view: UIView, with image: UIImage) {
        ...
        let screenWidth = EDImagePickerConfiguration.screenWidth
...
extension EDAssetZoomableView: UIScrollViewDelegate {
    ...
    func scrollViewDidEndZooming(_ scrollView: UIScrollView, with view: UIView?, atScale scale: CGFloat) {
        ...
        // prevent to zoom out
        if EDConfig.library.onlySquare && scale < squaredZoomScale {
