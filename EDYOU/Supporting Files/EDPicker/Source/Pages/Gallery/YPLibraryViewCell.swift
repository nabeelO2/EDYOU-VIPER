...
class EDMultipleSelectionIndicator: UIView {
    ...
    convenience init() {
        ...
        label.font = EDConfig.fonts.multipleSelectionIndicatorFont
...
class YPLibraryViewCell: UICollectionViewCell {
    ...
    let multipleSelectionIndicator = EDMultipleSelectionIndicator()
    ...
    override init(frame: CGRect) {
        ...
        durationLabel.font = EDConfig.fonts.durationFont
