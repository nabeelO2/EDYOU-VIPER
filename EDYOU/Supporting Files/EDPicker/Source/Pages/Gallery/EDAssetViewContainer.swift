...
final class EDAssetViewContainer: UIView {
    public var zoomableView: EDAssetZoomableView
    ...
    public let multipleSelectionButton: UIButton = {
        let v = UIButton()
        v.setImage(EDConfig.icons.multipleSelectionOffIcon, for: .normal)
        return v
    }()
    public var onlySquare = EDConfig.library.onlySquare
    public var isShown = true
    public var spinnerIsShown = false
    
    private let spinner = UIActivityIndicatorView(style: .white)
    private var shouldCropToSquare = EDConfig.library.isSquareByDefault
    private var isMultipleSelectionEnabled = false

    public var itemOverlayType = EDConfig.library.itemOverlayType

    init(frame: CGRect, zoomableView: EDAssetZoomableView) {
        ...
        if !onlySquare {
            // Crop Button
            squareCropButton.setImage(EDConfig.icons.cropIcon, for: .normal)
    ...
    required init?(coder: NSCoder) {
        zoomableView = EDAssetZoomableView()
    ...
    public func setMultipleSelectionMode(on: Bool) {
        ...
        let image = on ? EDConfig.icons.multipleSelectionOnIcon : EDConfig.icons.multipleSelectionOffIcon
...
extension EDAssetViewContainer: YPAssetZoomableViewDelegate {
    public func ypAssetZoomableViewDidLayoutSubviews(_ zoomableView: EDAssetZoomableView) {
...
extension EDAssetViewContainer: UIGestureRecognizerDelegate {
