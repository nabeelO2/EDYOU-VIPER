...
internal final class EDLibraryView: UIView {
    ...
    internal let collectionView: UICollectionView = {
        ...
        v.backgroundColor = EDConfig.colors.libraryScreenBackgroundColor
        v.collectionViewLayout = layout
        v.showsHorizontalScrollIndicator = false
        v.alwaysBounceVertical = true
        return v
    }()
    internal lazy var assetViewContainer: EDAssetViewContainer = {
        let v = EDAssetViewContainer(frame: .zero, zoomableView: assetZoomableView)
        v.accessibilityIdentifier = "assetViewContainer"
        return v
    }()
    internal let assetZoomableView: EDAssetZoomableView = {
        let v = EDAssetZoomableView(frame: .zero)
    ...
    internal let maxNumberWarningLabel: UILabel = {
        let v = UILabel()
        v.font = EDConfig.fonts.libaryWarningFont
        return v
    }()
    ...
    private let progressView: UIProgressView = {
        ...
        v.trackTintColor = EDConfig.colors.progressBarTrackColor
        v.progressTintColor = EDConfig.colors.progressBarCompletedColor ?? EDConfig.colors.tintColor
        v.isHidden = true
