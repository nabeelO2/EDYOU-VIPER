...
internal final class EDPhotoCaptureHelper: NSObject {
    var currentFlashMode: EDFlashMode {
        return EDFlashMode(torchMode: device?.torchMode)
    }
...
extension EDPhotoCaptureHelper {
...
extension EDPhotoCaptureHelper: AVCapturePhotoCaptureDelegate {
...
// MARK: - Private
private extension EDPhotoCaptureHelper {
    ...
    private func setCurrentOrienation() {
        ...
        let orientation = EDDeviceOrientationHelper.shared.currentDeviceOrientation
        switch orientation {
        case .portrait:
