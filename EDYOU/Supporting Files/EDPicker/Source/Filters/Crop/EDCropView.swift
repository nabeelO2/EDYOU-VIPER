...
final class EDCropView: UIView {
    ...
    private var isCircle: Bool {
        if case YPCropType.circle = EDConfig.showsCrop {
            return true
        }
        return false
    }
    ...
    convenience init(image: UIImage) {
        ...
        grid.isHidden = !EDConfig.showsCropGridOverlay
    }
    ...
    private func applyStyle() {
        ...
        cropArea.style { v in
            v.backgroundColor =  isCircle ? EDConfig.colors.cropOverlayColor : .clear
            v.isCircle = isCircle
    ...
    private func curtainStyle(v: UIView) {
        ...
        v.backgroundColor = EDConfig.colors.cropOverlayColor
        v.isUserInteractionEnabled = false
    }
}
