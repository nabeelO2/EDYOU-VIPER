...
final class EDFilterCollectionViewCell: UICollectionViewCell {
    ...
    override var isSelected: Bool {
        didSet {
            ...
            name.font = isSelected
				? EDConfig.fonts.filterSelectionSelectedFont
				: EDConfig.fonts.filterSelectionUnSelectedFont
        }
    }
    ...
    override init(frame: CGRect) {
        ...
        name.font = EDConfig.fonts.filterNameFont
