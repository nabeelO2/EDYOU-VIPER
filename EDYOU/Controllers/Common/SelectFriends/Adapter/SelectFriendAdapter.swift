...
class SelectFriendAdapter: NSObject {
...
extension SelectFriendAdapter {
}


// MARK: - TableView DataSource and Delegates
extension SelectFriendAdapter: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if isLoading {
            ...
            cell.imgCheckMark.image = searchedFriends[indexPath.row].isSelected ? UIImage(systemName: "checkmark.circle.fill") : UIImage(named: "Uncheck_Image")
