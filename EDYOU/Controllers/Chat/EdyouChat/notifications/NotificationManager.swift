...
public class NotificationManager {
    ...
    private let logger = Logger.init()//(subsystem: Bundle.main.bundleIdentifier!, category: "NotificationManager");
    ...
    func shouldNotify() -> Bool {
        ...
        case .message(let message, _):
            ...
            case .none:
                return false;
            case .mention:
                if let nickname = (conversation as? XMPPRoom)?.nickname ?? (conversation as? Channel)?.nickname {
