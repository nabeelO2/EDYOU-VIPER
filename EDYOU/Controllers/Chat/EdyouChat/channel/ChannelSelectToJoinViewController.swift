...
class ChannelJoinStatusView: UIBarButtonItem {
    ...
    var account: BareJID? {
        didSet {
            ...
            value.append(NSAttributedString(string: account?.stringValue ?? NSLocalizedString("None", comment: "channel join status view label"), attributes: [.font: UIFont.preferredFont(forTextStyle: .caption1), .foregroundColor: UIColor.systemTintColor]));
    ...
    var server: String? {
        didSet {
            ...
            value.append(NSAttributedString(string: server ?? NSLocalizedString("Automatic", comment: "channel join status view label"), attributes: [.font: UIFont.preferredFont(forTextStyle: .caption1), .foregroundColor: UIColor.systemTintColor]));
