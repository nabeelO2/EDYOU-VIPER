//
// XMPPPushNotificationsModule.swift
//
// EdYou
...
open class XMPPPushNotificationsModule: TigasePushNotificationsModule {
    ...
    fileprivate let provider: XMPPPushNotificationsModuleProviderProtocol;
    
    public init(defaultPushServiceJid: JID, provider: XMPPPushNotificationsModuleProviderProtocol) {
...
public protocol XMPPPushNotificationsModuleProviderProtocol {
