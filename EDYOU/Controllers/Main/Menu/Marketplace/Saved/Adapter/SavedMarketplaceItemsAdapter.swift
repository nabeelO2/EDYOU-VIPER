//
//  SavedMarketplaceItemsAdapter.swift
//  EDYOU
//
...
class SavedMarketplaceItemsAdapter: NSObject {
    ...
    var parent: SavedMarketplaceItemsController? {
        return collectionView.viewContainingController() as? SavedMarketplaceItemsController
    }
...
// MARK: - Actions
extension SavedMarketplaceItemsAdapter {
...
extension SavedMarketplaceItemsAdapter: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
