...
class PostDetailsController: BaseController {
    ...
    var adapter: PostDetailsAdapter!
    ...
    override func viewDidLoad() {
        ...
        adapter = PostDetailsAdapter(tableView: tableView, post: post)
        getPostDetails()
...
//            tablviewBottomHeight.constant = 0
    ...
    init(post: Post, prefilledComment: String?, commentId : String? = nil) {
        ...
        super.init(nibName: PostDetailsController.name, bundle: nil)
...
extension PostDetailsController {
    ...
    func setUserInformation() {
        ...
        let instituteName = self.post.user?.getCurrentEducation()?.instituteName ?? "N/A"
...
extension PostDetailsController: DPTagTextViewDelegate {
