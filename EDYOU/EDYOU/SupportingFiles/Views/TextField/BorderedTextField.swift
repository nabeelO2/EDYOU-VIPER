...
extension BorderedTextField {
    func setupDatePicker(maximumDate: Date, minimumDate: Date?, dateFormat: String? = nil, selectedDate: Date? = nil, pickerMode : UIDatePicker.Mode = .date) {
        ...
        self.textField.text = selectedDate?.stringValue(format: self.dateFormat)
    }
...
//    func checkTxtFieldValidation(startDate: String?, endDate:String?) -> Bool {
//        let startTxtDate = startDate
//        let endTxtDate = endDate
//        let startDate = startTxtDate?.toDate
//        let endDate = endTxtDate?.toDate
//        if let isGreater = startDate.isGreaterThan(endDate) {
//            isGreater = false
//        }
//        if let isEqual = startDate.isEqualTo(endDate) {
//            isEqual = false
//        }
